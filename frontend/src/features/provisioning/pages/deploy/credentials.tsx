...
import { getCredentials, createCredential, updateCredential, deleteCredential, batchDeleteCredentials } from '@/features/provisioning/api/deploy'
import type { Credential, CreateCredentialRequest } from '@/features/provisioning/types'
