...
const props = defineProps<{ data: any[]; persistKey: string; showTools: boolean; canWrite: boolean; openRoleYaml: (row: any) => void; openRoleEdit: (row: any) => void; deleteRoleRow: (row: any) => void }>()
