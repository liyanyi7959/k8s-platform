...
const props = defineProps<{ data: any[]; persistKey: string; showTools: boolean; canWrite: boolean; openClusterRoleBindingYaml: (row: any) => void; openClusterRoleBindingEdit: (row: any) => void; deleteClusterRoleBindingRow: (row: any) => void }>()
