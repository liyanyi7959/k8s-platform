  ...
  >
    ...
    <template #cell-actions="{ row }">
      <div class="k8s-act-group">
        <el-tooltip content="详情" placement="top" :show-after="300"><button class="k8s-act-btn k8s-act-btn--info" @click="props.openRoleBindingDetail(row)"><el-icon><View /></el-icon></button></el-tooltip>
...
const props = defineProps<{ data: any[]; persistKey: string; showTools: boolean; canWrite: boolean; openRoleBindingDetail: (row: any) => void; openRoleBindingYaml: (row: any) => void; openRoleBindingEdit: (row: any) => void; deleteRoleBindingRow: (row: any) => void }>()
