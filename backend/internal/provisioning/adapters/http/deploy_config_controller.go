...
type DeployConfigController struct {
	svc *provisionapp.DeployConfigService
}

func NewDeployConfigController(svc *provisionapp.DeployConfigService) *DeployConfigController {
...
func (dc *DeployConfigController) UpdateConfig(c *gin.Context) {
	...
	var req provisionapp.UpdateConfigRequest
...
func (dc *DeployConfigController) CreateRepository(c *gin.Context) {
	var req provisionapp.CreateRepositoryRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		resp.Fail(c, 4000, "请求参数错误")
		return
	}
...
func (dc *DeployConfigController) UpdateRepository(c *gin.Context) {
	...
	var req provisionapp.UpdateRepositoryRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		resp.Fail(c, 4000, "请求参数错误")
		return
	}
