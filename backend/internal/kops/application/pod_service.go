...
func (s *PodService) CreateExecSession(input PodExecSessionInput) (*PodExecSessionResult, error) {
	...
	return &PodExecSessionResult{SessionID: sessionID, WSURL: "/api/v1/ws/pod-exec?session_id=" + sessionID}, nil
}
...
func (s *PodService) CreateLogSession(input PodLogSessionInput) (*PodLogSessionResult, error) {
	...
	return &PodLogSessionResult{SessionID: sessionID, WSURL: "/api/v1/ws/pod-log?session_id=" + sessionID}, nil
}
