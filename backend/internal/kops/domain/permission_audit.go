...
// JSONMap is the JSON-column value object owned by Kops persistence entities.
// It retains GORM's Scanner/Valuer contract without coupling this context to
// the legacy model package.
...
// K8sPermissionAudit records a managed-cluster or ad-hoc credential audit.
...
// K8sPermissionAuditFinding captures a resource or workload-level result.
