...
// ManifestApplyRecord is the durable audit trail for a Kops manifest apply or
// dry-run. The YAML and result are deliberately retained so a resource change
// can be inspected without reaching back into the live cluster.
