...
func BuiltinPermissions() map[string]string {
	return map[string]string{
		"sys:user_admin":            "用户/角色权限管理",
		"sys:credential_admin":      "凭据管理",
		"sys:credential_read":       "凭据查看",
		"sys:credential_create":     "凭据新增",
		"sys:credential_update":     "凭据编辑",
		"sys:credential_delete":     "凭据删除",
		"automation:job_read":       "自动化作业查看",
		"automation:job_write":      "自动化作业管理",
		"automation:job_run":        "自动化作业执行",
		"automation:template_admin": "Playbook 模板管理",
		"server:read":               "服务器查看",
		"server:write":              "服务器管理",
		"server:terminal":           "服务器终端",
		"server:exec":               "服务器任务执行",
		"cluster:read":              "集群查看",
		"cluster:create":            "集群创建",
		"k8s:read":                  "K8s 资源查看",
