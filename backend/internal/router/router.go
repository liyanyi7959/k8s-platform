...
func registerRoutes(
	...
	registerK8sRoutes(authed, d, modules.kops.resources, modules.kops.manifests, modules.kops.namespaces, modules.kops.metrics, modules.kops.connectivity, modules.kops.nodes, modules.kops.platform, modules.kops.relationships, modules.kops.batch, modules.kops.network, modules.kops.configuration, modules.kops.storage, modules.kops.helm, modules.kops.workloads, modules.kops.pods, modules.kops.inspection, modules.kops.creator)
	registerWebSocketRoutes(authed, modules.kops.resources, modules.kops.podLogStream, modules.kops.podExecStream)
